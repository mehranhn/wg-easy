...
| `WG_MTU` | `null` | `1420` | The MTU the clients will use. if WG_SERVER_MTU is not defined server will use this value too. |
| `WG_SERVER_MTU` | `null` | `1420` | The MTU the server will use. |
| `WG_FWMARK` | `null` | `0x5432` | The FWMARK of the server. |
